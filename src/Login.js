                    ...
                    <div className="col-lg-4 col-md-6 offset-md-3 offset-lg-4 col-sm-12">
                        ...
                        <form className="form-signin">
                            ...
                            <input type="password" id="inputPassword" className="form-control"
                                   placeholder="Password" required="" value={this.state.inputValues.inputPassword} onChange={this.onInputChange}/>
                            <input type="button" className="btn btn-md btn-primary btn-block" value="Log in"
                                   onClick={this.handleSignIn}/>
                            <a href="#" className="text-center btn-block" >Don't have account?</a>
                        </form>
                    </div>
                </div>
            </React.Fragment>
